      ...
      <div className="max-w-[1200px] mx-auto px-4 lg:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="absolute top-3 right-3 max-w-[calc(100%-1.5rem)] text-center bg-primary-container text-on-primary px-3 sm:px-4 py-1 rounded-full font-label-badge text-[10px] sm:text-label-badge font-bold uppercase tracking-wider shadow-md">
          ...
          <div className="lg:col-span-7 flex flex-col gap-5 sm:gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-4 sm:p-5 bg-surface-container-lowest rounded-xl shadow-sm border border-surface-container-high">
                <div className="w-10 h-10 rounded-lg bg-secondary-fixed/40 text-secondary flex items-center justify-center mb-3">
                  <Users className="w-5 h-5" />
                </div>
                <h4 className="font-title-md text-title-md text-on-surface mb-1 font-bold">Strict Micro-Batches</h4>
              ...
              <div className="p-4 sm:p-5 bg-surface-container-lowest rounded-xl shadow-sm border border-surface-container-high">
                ...
                <h4 className="font-title-md text-title-md text-on-surface mb-1 font-bold">Daily HW Guidance</h4>
                <p className="text-body-sm text-on-surface-variant">
              ...
              <div className="p-4 sm:p-5 bg-surface-container-lowest rounded-xl shadow-sm border border-surface-container-high">
                ...
                <h4 className="font-title-md text-title-md text-on-surface mb-1 font-bold">Weekly Diagnostic Reports</h4>
                <p className="text-body-sm text-on-surface-variant">
            ...
            {/* Subjects Matrix */}
            <div className="p-4 sm:p-5 bg-surface-container-lowest rounded-xl shadow-sm border border-surface-container-high flex flex-col gap-3">
              <div className="font-title-md text-sm sm:text-title-md text-on-surface font-bold flex items-center gap-2">
                <BookOpen className="w-4 h-4 sm:w-5 sm:h-5 text-primary-container shrink-0" />
                <span>Subjects Mentored with Specialization:</span>
              </div>
              <div className="flex flex-wrap gap-1.5 sm:gap-2 text-xs sm:text-body-sm text-on-surface-variant">
                <span className="px-3 py-1 bg-surface-container-high rounded-full font-medium">
